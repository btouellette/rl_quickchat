...
FadeDelay      := 500000 ; number of milliseconds before menu fades
...
F1::
    ...
    MessageGroup   := "APOLOGIES"   ; the category heading for this group (INFORMATIONAL/COMPLIMENTS/REACTIONS/APOLOGIES are the in-game headings)
    MessageUp      := "$#@%!"       ; message assigned to up for this group
    MessageLeft    := "No Problem." ; message assigned to left for this group
    MessageRight   := "Whoops..."   ; message assigned to right for this group
    MessageDown    := "Sorry!"      ; message assigned to down for this group
    Gosub Sub_BuildHTML
